...
function populateLocationDropdown() {
  ...
  // the use of option for searching by location
...
function populateParkTypeDropdown() {
  ...
  // the use of option for searching by park type
  const emptyOption = document.createElement("option");
  emptyOption.value = "";
...
// Function for the search results filter
function displaySearchData(results) {
  searchResults.innerHTML = "";

  if (results.length === 0) {
    searchResults.textContent = "No data found.";
  } else {
